...
import SongAlbum from './songsPlaylist'
...
class App extends Component {
  ...
  onClickDeleteTrack = id => {
    ...
    const filteredList = playList.filter(eachItem => eachItem.id !== id)
    this.setState({
  ...
  renderAppContainer = () => {
    ...
    const filterList = this.filteredListApp()
      ...
      <>
        ...
        <div className="playlist-container">
          <div className="top-container">
            <p className="paragraph">Songs Playlist</p>
            <div className="input-container">
              ...
              <div className="search-logo-container">
                <MdSearch className="search-logo" />
              </div>
            </div>
          </div>
          <ul>
